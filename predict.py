...
def predict():
    ...
    test9_dataset = TestDataset(root=f'./pt/test9_pt', pdb_file_path='data_process/data/test9_pdb',
                                fasta_file_path="data_process/data/test9_fastas",
                                msa_file_path='data_process/data/test9_ag',
                                em_file_path='data_process/data/test9_em',
                                asa_file_path="data_process/data/test9_asa",
                                label_file_path="data_process/label/test9_label.pkl", top_k=8)
